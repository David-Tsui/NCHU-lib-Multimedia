...
!function(t,e,n){"use strict";function i(t,e){var n=null;return function(){var i=this,r=arguments;null===n&&(n=setTimeout(function(){t.apply(i,r),n=null},e))}}var r=function(){var t={};return function(e){if(t[e]!==n)return t[e];var i=document.createElement("div"),r=i.style,a=e.charAt(0).toUpperCase()+e.slice(1),o=["webkit","moz","ms","o"],s=(e+" "+o.join(a+" ")+a).split(" ");for(var l in s)if(s[l]in r)return t[e]=s[l];return t[e]=!1}}(),a="http://www.w3.org/2000/svg",o=function(){var t;return function(){if(t!==n)return t;var e=document.createElement("div");return e.innerHTML="<svg/>",t=e.firstChild&&e.firstChild.namespaceURI===a}}(),s=t(e),l=r("transform"),c={itemContainer:"ul",itemSelector:"li",start:"center",fadeIn:400,loop:!1,autoplay:!1,pauseOnHover:!0,style:"coverflow",spacing:-.6,click:!0,keyboard:!0,scrollwheel:!0,touch:!0,nav:!1,buttons:!1,buttonPrev:"Previous",buttonNext:"Next",onItemSwitch:!1},u={main:"flipster",active:"flipster--active",container:"flipster__container",nav:"flipster__nav",navChild:"flipster__nav__child",navItem:"flipster__nav__item",navLink:"flipster__nav__link",navCurrent:"flipster__nav__item--current",navCategory:"flipster__nav__item--category",navCategoryLink:"flipster__nav__link--category",button:"flipster__button",buttonPrev:"flipster__button--prev",buttonNext:"flipster__button--next",item:"flipster__item",itemCurrent:"flipster__item--current",itemPast:"flipster__item--past",itemFuture:"flipster__item--future",itemContent:"flipster__item__content"},f=new RegExp("\\b("+u.itemCurrent+"|"+u.itemPast+"|"+u.itemFuture+")(.*?)(\\s|$)","g"),p=new RegExp("\\s\\s+","g");t.fn.flipster=function(e){var r="string"==typeof e;if(r){var v=Array.prototype.slice.call(arguments,1);return this.each(function(){var n=t(this).data("methods");return n[e]?n[e].apply(this,v):this})}var h=t.extend({},c,e);return this.each(function(){function e(t){var e="next"===t?h.buttonNext:h.buttonPrev;return"custom"!==h.buttons&&o?'<svg viewBox="0 0 13 20" xmlns="'+a+'" aria-labelledby="title"><title>'+e+'</title><polyline points="10,3 3,10 10,17"'+("next"===t?' transform="rotate(180 6.5,10)"':"")+"/></svg>":e}function r(n){return n=n||"next",t('<button class="'+u.button+" "+("next"===n?u.buttonNext:u.buttonPrev)+'" role="button" />').html(e(n)).on("click",function(t){b(n),t.preventDefault()})}function c(){h.buttons&&S.length>1&&(R.find("."+u.button).remove(),R.append(r("prev"),r("next")))}function v(){var e={};!h.nav||S.length<=1||(F&&F.remove(),F=t('<ul class="'+u.nav+'" role="navigation" />'),H=t(""),S.each(function(n){var i=t(this),r=i.data("flip-category"),a=i.data("flip-title")||i.attr("title")||n,o=t('<a href="#" class="'+u.navLink+'">'+a+"</a>").data("index",n);if(H=H.add(o),r){if(!e[r]){var s=t('<li class="'+u.navItem+" "+u.navCategory+'">'),l=t('<a href="#" class="'+u.navLink+" "+u.navCategoryLink+'" data-flip-category="'+r+'">'+r+"</a>").data("category",r).data("index",n);e[r]=t('<ul class="'+u.navChild+'" />'),H=H.add(l),s.append(l,e[r]).appendTo(F)}e[r].append(o)}else F.append(o);o.wrap('<li class="'+u.navItem+'">')}),F.on("click","a",function(e){var n=t(this).data("index");n>=0&&(b(n),e.preventDefault())}),"after"===h.nav?R.append(F):R.prepend(F),z=F.find("."+u.navItem))}function d(){if(h.nav){var e=Y.data("flip-category");z.removeClass(u.navCurrent),H.filter(function(){return t(this).data("index")===O||e&&t(this).data("category")===e}).parent().addClass(u.navCurrent)}}function m(){R.css("transition","none"),j.css("transition","none"),S.css("transition","none")}function g(){R.css("transition",""),j.css("transition",""),S.css("transition","")}function _(){var e,n=0;return S.each(function(){e=t(this).height(),e>n&&(n=e)}),n}function y(e){return e&&m(),M=j.width(),j.height(_()),M?(N&&(clearInterval(N),N=!1),void S.each(function(n){var i,r,a=t(this);a.attr("class",function(t,e){return e&&e.replace(f,"").replace(p," ")}),i=a.outerWidth(),0!==h.spacing&&a.css("margin-right",i*h.spacing+"px"),r=a.position().left,A[n]=-1*(r+i/2-M/2),n===S.length-1&&(x(),e&&setTimeout(g,1))})):void(N=N||setInterval(function(){y(e)},500))}function x(){var e,i,r,a=S.length;S.each(function(n){e=t(this),i=" ",n===O?(i+=u.itemCurrent,r=a+1):O>n?(i+=u.itemPast+" "+u.itemPast+"-"+(O-n),r=n):(i+=u.itemFuture+" "+u.itemFuture+"-"+(n-O),r=a-n),e.css("z-index",r).attr("class",function(t,e){return e&&e.replace(f,"").replace(p," ")+i})}),O>=0&&(M&&A[O]!==n||y(!0),l?j.css("transform","translateX("+A[O]+"px)"):j.css({left:A[O]+"px"})),d()}function b(t){var e=O;if(!(S.length<=1))return"prev"===t?O>0?O--:h.loop&&(O=S.length-1):"next"===t?O<S.length-1?O++:h.loop&&(O=0):"number"==typeof t?O=t:t!==n&&(O=S.index(t)),Y=S.eq(O),O!==e&&h.onItemSwitch&&h.onItemSwitch.call(R,S[O],S[e]),x(),R}function C(t){return h.autoplay=t||h.autoplay,clearInterval(U),U=setInterval(function(){var t=O;b("next"),t!==O||h.loop||clearInterval(U)},h.autoplay),R}function w(){return clearInterval(U),U=0,R}function I(t){return w(),h.autoplay&&t&&(U=-1),R}function k(){y(!0),R.hide().css("visibility","").addClass(u.active).fadeIn(h.fadeIn)}function P(){return j=R.find(h.itemContainer).addClass(u.container),S=j.find(h.itemSelector),S.length<=1?void 0:(S.addClass(u.item).each(function(){var e=t(this);e.children("."+u.itemContent).length||e.wrapInner('<div class="'+u.itemContent+'" />')}),h.click&&S.on("click.flipster touchend.flipster",function(e){q||(t(this).hasClass(u.itemCurrent)||e.preventDefault(),b(this))}),c(),v(),O>=0&&b(O),R)}function D(t){h.keyboard&&(t[0].tabIndex=0,t.on("keydown.flipster",i(function(t){var e=t.which;(37===e||39===e)&&(b(37===e?"prev":"next"),t.preventDefault())},250,!0)))}function E(t){if(h.scrollwheel){var e,n,r=!1,a=0,o=0,l=0;t.on("mousewheel.flipster wheel.flipster",function(){r=!0}).on("mousewheel.flipster wheel.flipster",i(function(t){clearTimeout(o),o=setTimeout(function(){a=0,l=0},300),t=t.originalEvent,l+=t.wheelDelta||-1*(t.deltaY+t.deltaX),Math.abs(l)<25||(a++,e=l>0?"prev":"next",n!==e&&(a=0),n=e,(6>a||a%3===0)&&b(e),l=0)},50)),s.on("mousewheel.flipster wheel.flipster",function(t){r&&(t.preventDefault(),r=!1)})}}function T(t){if(h.touch){var e,n,r,a,o=!1,s=i(b,300);t.on({"touchstart.flipster":function(t){t=t.originalEvent,q=t.touches?t.touches[0].clientX:t.clientX,o=t.touches?t.touches[0].clientY:t.clientY},"touchmove.flipster":i(function(t){q!==!1&&(t=t.originalEvent,e=t.touches?t.touches[0].clientX:t.clientX,n=t.touches?t.touches[0].clientY:t.clientY,r=n-o,a=e-q,Math.abs(r)<100&&Math.abs(a)>=30&&(s(0>a?"next":"prev"),q=e,t.preventDefault()))},100),"touchend.flipster touchcancel.flipster ":function(){q=!1}})}}function L(){var t;if(R.css("visibility","hidden"),P(),S.length<=1)return void R.css("visibility","");t=!!h.style&&"flipster--"+h.style.split(" ").join(" flipster--"),R.addClass([u.main,l?"flipster--transform":" flipster--no-transform",t,h.click?"flipster--click":""].join(" ")),h.start&&(O="center"===h.start?Math.floor(S.length/2):h.start),b(O);var e=R.find("img");if(e.length){var n=0;e.on("load",function(){n++,n>=e.length&&k()}),setTimeout(k,750)}else k();s.on("resize.flipster",i(y,400)),h.autoplay&&C(),h.pauseOnHover&&j.on("mouseenter.flipster",function(){U?I(!0):w()}).on("mouseleave.flipster",function(){-1===U&&C()}),D(R),E(j),T(j)}var X,j,M,N,S,Y,F,z,H,R=t(this),A=[],O=0,U=!1,q=!1;X={jump:b,next:function(){return b("next")},prev:function(){return b("prev")},play:C,stop:w,pause:I,index:P},R.data("methods",X),R.hasClass(u.active)||L()})}}(jQuery,window);
